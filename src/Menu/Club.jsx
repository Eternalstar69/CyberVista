...
function Club() {
    const images = [
      process.env.PUBLIC_URL +'/image/clubs1.jpg',
      process.env.PUBLIC_URL + '/image/clubs2.jpg',
      process.env.PUBLIC_URL + '/image/clubs3.jpg',
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%',backgroundColor:'#f8f4e1' }} >
           <BackgroundSection image='Club.jpg' />
           <SlideMenu />
           <IntroductionSection
            title1="FIGHT OF CLUBS"
            // title2=
            subtitle1="A PLACE FOR DRINKS"
            subtitle2="AND CONVERSATION"
            hours="MONDAY–SUNDAY, 3 P.M TO 11 P.M."
            // service=
            // service2=
            additionalInfo="RESERVATIONS RECOMMENDED FOR NON-HOTEL GUESTS AND WALK-INS WELCOME BASED ON AVAILABILITY. 21+ ONLY. 
            "
        />
         <BoxPright
         
        imageSrc="./image/clubs.jpg"
        title1="XDD "
        title2=" THE RAT KING
        "
        description="The Rat King is a place of serenity for you to relax and rejuvenate. We offer a variety of treatments and services to help you feel your best. Our sauna is a place of serenity for you to relax and rejuvenate. We offer a variety of treatments and services to help you feel your best.
        "
