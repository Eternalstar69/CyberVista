...
function Cafe() {
    const images = [
      process.env.PUBLIC_URL +'/image/cafe1.jpg',
      process.env.PUBLIC_URL +'/image/cafe2.jpg',
      process.env.PUBLIC_URL +'/image/cafe3.jpg',
      process.env.PUBLIC_URL +'/image/cafe4.jpg',
      process.env.PUBLIC_URL +'/image/cafe5.jpg',
      process.env.PUBLIC_URL +'/image/cafe6.jpg'
      ];
    ...
    return (
        ...
        {/* <BackgroundSection image="cafe6.png" />   
             */}
            <SlideMenu />
            <IntroductionSection
            title1="XDD"
            title2="Café"
            subtitle1="HEALTHY EATING"
            subtitle2="HEALTHY LIVING"
            hours="MONDAY–SUNDAY, 7 A.M. TO 2 P.M."
            service="OFFERING COUNTER-SERVICE"
            service2="BREAKFAST AND LUNCH"
            additionalInfo="We are proud to serve bold, richly flavored Burundi Star Coffee—whose mission goes beyond what’s in your cup. Sourcing coffee directly from her home country of Burundi, owner Jocelyne Kamikazi is helping"
        />
           <BoxPleft
        imageSrc="/image/cafe.jpg"
        title1="XDD"
        title2="Café"
        description="Our café is a place of serenity for you to relax and rejuvenate. We offer a variety of healthy and delicious options to help you feel your best. Our café is a place of serenity for you to relax and rejuvenate. We offer a variety of healthy and delicious options to help you feel your best."
